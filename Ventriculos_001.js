// draw ventricle using WebGL
//
// written by Louis Vu on October 1, 2017

function drawVentriculos(canvas,gl,m4,framebuffer,drawImg,degree){
    ...
    // Scene (re-)draw routine
		...
		gl.uniform3fv(shaderProgram.cubecolor_vec,[.868,.278,.161]);
		gl.uniform3fv(shaderProgram.fakecolor_vec,[1,0,1]);
