// draw right atrium using WebGL
//
// written by Louis Vu on October 1, 2017

function drawAuricula(canvas,gl,m4,framebuffer,drawImg,degree){
	var vertices = vertCalc(LoadedOBJFiles["Human_heart.obj"].groups['Auricula_izq_Cube.004' ]);
	var normalArr = normCalc(LoadedOBJFiles["Human_heart.obj"].groups['Auricula_izq_Cube.004' ]);
    ...
    // Scene (re-)draw routine
		...
		gl.uniform3fv(shaderProgram.cubecolor_vec,[.64,.74,.84]);
		gl.uniform3fv(shaderProgram.fakecolor_vec,[0,1,0]);
