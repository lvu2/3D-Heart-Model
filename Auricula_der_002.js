// draw left atrium using WebGL
//
// written by Louis Vu on October 1, 2017

function drawAuricula_002(canvas,gl,m4,framebuffer,drawImg,degree){
	var vertices = vertCalc(LoadedOBJFiles["Human_heart.obj"].groups['Auricula_der_Cube.002' ]);
	var normalArr = normCalc(LoadedOBJFiles["Human_heart.obj"].groups['Auricula_der_Cube.002' ]);
    ...
    // Scene (re-)draw routine
		...
		gl.uniform3fv(shaderProgram.cubecolor_vec,[1,.913,.525]);
		gl.uniform3fv(shaderProgram.fakecolor_vec,[1,1,0]);
